...
<div class="right-div">
<h3>Pay online on this osc@pay.com</h3>
<input class="input-style" type="text" name="transactionId" placeholder="Enter transaction ID">
<h3 style="color: red">*If you have selected online Payment mode then enter your transaction ID.</h3>
</div>
<hr style="width: 100%">
...
<div class="right-div">
<h3 style="color: red">*If you enter wrong transaction id then your order will we be cancelled!</h3>
